...
from recruitment.models import RecruitmentModel
...
class Dashboard(LoginRequiredMixin,ListView):
   ...
   def get_context_data(self, **kwargs):
        ...
        context['rect_total'] = RecruitmentModel.objects.all().count()
        ...
        context['recruitments'] = RecruitmentModel.objects.order_by('-id')
        return context
